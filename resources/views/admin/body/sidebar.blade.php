    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="setting">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('social.setting')}}"> Social Settings </a>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('seo.setting')}}"> Seo Settings </a></li>

                    <li class="nav-item"> <a class="nav-link" href="{{route('livetv.setting')}}"> LiveTV Settings </a>
                    </li>

                    <li class="nav-item"> <a class="nav-link" href="{{route('notice.setting')}}"> Notice Settings </a>
                    </li>

                    <li class="nav-item"> <a class="nav-link" href="{{route('website.setting')}}"> Website Settings </a>
                    </li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('add.writer')}}">Add User</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('all.writer')}}"> All User</a></li>
                </ul>
            </div>
        </li>
        @else
