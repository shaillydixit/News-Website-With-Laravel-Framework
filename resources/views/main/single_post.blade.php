...
@php
$latest = DB::table('post')->orderBy('id','desc')->limit(8)->get();
$favourite = DB::table('post')->orderBy('id','desc')->inRandomOrder()->limit(8)->get();
$highest = DB::table('post')->orderBy('id','asc')->inRandomOrder()->limit(8)->get();
