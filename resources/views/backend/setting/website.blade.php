...
action="{{route('update.website' , $websitesetting->id)}}" enctype="multipart/form-data">
@csrf
...
<label for="exampleFormControlFile1">Website Logo Upload </label>
...
<textarea class="form-control" name="address_hin" 
id="summernote1">
...
<input type="text" class="form-control" name="phone_hin" 
value="{{$websitesetting->phone_hin}}">
</div>
