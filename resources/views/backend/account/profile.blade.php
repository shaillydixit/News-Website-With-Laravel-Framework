...
<div class="card" style="width: 18rem;">
  <img src="{{(!empty($editData->image))? url('upload/user_images/'.$editData->image):url('upload/no.jpeg')}}" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <p class="card-text">Position : {{Auth::user()->position}}</p>
  </div>
</div>
